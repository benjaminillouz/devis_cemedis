...
function saveSignature() {
    ...
    if (isEmpty) {
        showNotification('Veuillez signer avant de valider', 'warning');
        return;
    }
    ...
    // Ici vous pouvez envoyer la signature au serveur
    showNotification('Signature sauvegardée avec succès !', 'success');
